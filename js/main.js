...
(function ($) {
    ...
    /*==================================================================
    [ Show modal2 ]*/
    $('.js-show-modal2').on('click',function(f){
        f.preventDefault();
 ...
 /*==================================================================
    [ Show modal3 ]*/
    $('.js-show-modal3').on('click',function(f){
        f.preventDefault();
    ...
    $('.js-hide-modal3').on('click',function(){
     ...
     /*==================================================================
    [ Show modal4 ]*/
    $('.js-show-modal4').on('click',function(f){
        f.preventDefault();
    ...
    [ Show modal4 ]*/
    $('.js-show-modal5').on('click',function(f){
        f.preventDefault();
    ...
    $('.js-show-modal6').on('click',function(f){
        f.preventDefault();
    ...
    $('.js-hide-modal6').on('click',function(){
     ...
     /*==================================================================
    [ Show modal7 ]*/
    $('.js-show-modal7').on('click',function(f){
        f.preventDefault();
    ...
    $('.js-hide-modal7').on('click',function(){
     ...
     /*==================================================================
    [ Show modal8 ]*/
    $('.js-show-modal8').on('click',function(f){
        f.preventDefault();
